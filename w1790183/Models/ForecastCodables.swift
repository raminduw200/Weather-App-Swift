...
struct Current: Codable, Identifiable {
    ...
    var windDir: String {
        let degreeDirections: [String] = ["N","NNE","NE","ENE","E","ESE","SE","SSE","S","SSW","SW","WSW","W","WNW","NW","NNW","N"]
        return degreeDirections[Int((Double(self.windDeg) / 22.5) + 0.5) % degreeDirections.count]
    }
}
